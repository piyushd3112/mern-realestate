      ...
      <input type="checkbox" id="offer" className='w-5'/> <span>Offer</span>
        ...
        <div className='flex flex-col gap-4 flex-1 gap-4'>
          ...
          <div className="flex gap-4">
            ...
            <input onChange={(e)=>setFiles(e.target.files)} className='p-3 border-gray-300 rounded w-full' type="file" name="" id="images" accept='image/*' multiple />
        ...
        <button className="p-3 bg-slate-500 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80">Create Listing</button>
